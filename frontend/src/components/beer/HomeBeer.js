        ...
        <div className='container'>
            ...
            <div>
                ...
                <div>
                    ...
                    <button id={"bt3"} className="btn btn-outline-primary mx-2" onClick={()=>changePage()}>{Math.floor((pageNr)/100+1)}</button>
                    <button id={"bt4"} className="btn btn-outline-primary mx-2" onClick={()=>changePage()}>{Math.floor((pageNr)/100+2)}</button>
